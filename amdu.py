...
def audioFileAttrUpdate(directory_path, file_extension):
	...
	if file_extension is None:
		print("File extension is not provided")
		return
...
if __name__ == '__main__':
    ...
    parser.add_argument('directory_path', type=str, help='Path to directory containing audio files.')
    parser.add_argument('file_extension', type=str, help='File extension of audio files to update.')
